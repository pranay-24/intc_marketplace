...
export interface CancerPlanBenefits {
  oneTimeBenefit: string;
  invasiveCancerBenefit: string;
  skinCancerBenefit: string;
  additionalOccurrence: {
    description: string;
    timeWithoutTreatment: {
      lessThan2Years: string;
      twoToFourYears: string;
      fivePlusYears: string;
    };
  };
}

interface CancerBenefitsRendererProps {
  benefits: CancerPlanBenefits;
}

export function CancerBenefitsRenderer({ benefits }: CancerBenefitsRendererProps) {
  return (
    <div className="mt-4">
      <h4 className="font-medium text-gray-700 mb-3">Your Cancer Plan Benefits:</h4>
      <div className="space-y-3">
        <BenefitItem 
          label="One-Time Benefit:" 
          value={benefits.oneTimeBenefit} 
        />
        <BenefitItem 
          label="Invasive Cancer Benefit:" 
          value={benefits.invasiveCancerBenefit} 
        />
        <BenefitItem 
          label="Skin Cancer Benefit:" 
          value={benefits.skinCancerBenefit} 
        />
